...
| 🔗 [AI-Driven Revenue Forecasting & Advertising Impact Dashboard](https://github.com/shalineesinghvit12-source/ai-revenue-forecasting-tableau) | Combined regression and Random Forest models with Tableau for real-time revenue prediction and a what-if simulator for ad spend, with MAPE/RMSE accuracy tracking. | Python, Random Forest, Regression, Tableau |
